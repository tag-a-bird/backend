...
from utils.db import db_session, func, configure_engine
...
route_blueprint = Blueprint('route_blueprint', "routes_module",        
...
def about():
    ...
    # testv = app.app.config['DATABASE_URI']
    # print("app.app.config['DATABASE_URI']:", app.app.config['DATABASE_URI'])
