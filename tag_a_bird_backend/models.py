...
class Record(Base):
        ...
        def __repr__(self):
            return f"Record(id={self.id!r}, audio_url={self.audio_url!r}, photo_url={self.photo_url!r}, comment={self.comment!r}, country={self.country!r}, city={self.city!r}, habitat={self.habitat!r}, species={self.species!r}, weather={self.weather!r}, date={self.date!r}, device_os={self.device_os!r}, is_holiday={self.is_holiday!r}, human_noise={self.human_noise!r}, device_model={self.device_model!r}, habitat_other={self.habitat_other!r}, species_other={self.species_other!r}, day_of_the_week={self.day_of_the_week!r}, human_noise_type={self.human_noise_type!r}, location_private={self.location_private!r}, location_accuracy={self.location_accuracy!r}, dawn_chorus_import_id={self.dawn_chorus_import_id!r}, human_noise_intensity={self.human_noise_intensity!r}, organization_membership={self.organization_membership!r}, advanced_audio_equipment={self.advanced_audio_equipment!r}, status={self.status!r})"
