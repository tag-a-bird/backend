...
@admin_bp.route('/admin/populate_db', methods=["GET"])
@login_required
@admin_access_required()
def populate_db_get():
    return render_template('admin/populate_db.html')

@admin_bp.route('/admin/populate_db', methods=["POST"])
@login_required
@admin_access_required()
def populate_db_post():
    try:
